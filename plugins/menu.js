...
┗━━━━━━━━━━⬣
%readmore
  ≡ * A L 3 A M E  ❤️ | M E N U القائمة *
`.trimStart(),
  header: '┏━━⊜ *_%category_* ',
  body: '┃⋄ %cmd %isdiamond %isPremium',
  footer: '┗━━━━━━━━⬣\n',
  after: '*إستخدامك للبوت بشكل صحيح يعني أنك تزيد من إحتمالية أن يبقى البوت شغالا لمدة أطول . 🌹لذا إن واجهتك أي مشكلة لا تخجل من سؤال صاحب البوت🤖🌹 .رابط تلجرام ❤️ سوف تجده في الأسفل + *\nhttps://t.me/AL3AMEABDO',
}
